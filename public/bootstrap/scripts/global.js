...
function popup(data, callback) { //调用例子dom.popup({txt:'xxxxxx',btn:2})
    ...
    var html = '<div class="loading_line" id="popup_pub" style="visibility: visible;">' +
        ...
        '<div class="popup_title" ' + hd_style + '>' + txt_title  +'</div>' +
    ...
    $('#popup_false').bind('click', function(e) {
        e.preventDefault();
        $('#popup_pub').hide();
    });
}
...
function showLoading(){
  $("body").append('<div id="loadingBox" class="loading_line show-popup"></div>');
  $("#loadingBox").html('<div class="box-middle"> <div class="spinner"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div> </div>');
}

//监听加载状态改变
document.onreadystatechange = closeLoading;
function closeLoading(){
  $("#loadingBox").removeClass("show-popup");
}
